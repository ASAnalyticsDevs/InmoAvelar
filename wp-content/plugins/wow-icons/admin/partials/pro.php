<div class="wow-admin-col">
	<div class="wow-admin-col-12">
		<p style="font-size:36px; margin-top:15px; padding-top:0px;">ADDITIONAL OPTIONS IN PRO VERSION <br/>
			<a href="https://wow-estore.com/item/wow-icons-pro/" target="_blank" class="wow-btn">GET PRO VERSION <i class="fa fa-download"></i></a> <a href="https://wow-estore.com/item/wow-icons-pro/" target="_blank" class="wow-btn">DEMO PRO VERSION <i class="fa fa-eye"></i></a>
		</p>
	</div>
</div>


<div class="wow-admin-col wow-futures" style="font-size:18px;">
	...
	<div class="wow-admin-col-12">
		<ul>
			...
			<li>Animation</li>
			<li>Icon title</li>
			<li>Placing icon after the menu item</li>
			<li>Icon color in the menu item</li>
			<li>And more...</li>
		</ul>
		</ul>
...
<p style="font-size:18px;">We will be very grateful if you <a href="https://wordpress.org/plugins/wow-icons/" target="_blank"><b/>leave a review about the plugin</b></a>.</p>
